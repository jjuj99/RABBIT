...
public interface UserControllerSwagger {
    ...
    @Operation(
            summary = "로그인 정보 조회",
            description = "토큰을 통해 로그인 한 유저의 이메일, 이름, 닉네임 정보를 조회합니다.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
    ...
    @Operation(
            summary = "마이페이지 정보 조회",
            description = "토큰을 통해 로그인 한 유저의 이메일, 이름, 닉네임, 은행, 계좌, 지갑 주소를 조회합니다.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = "로그인 정보 조회",
                                                    ...
                                                    value = """
                                                            {
                                                              ...
                                                              "data": {
                                                                ...
                                                                "nickname": "열정두배",
                                                                "bankName": "싸피은행",
                                                                "refundAccount": "123-45678-9012-34",
                                                                "walletAddress": "0xdbd...3f6b"
                                                              },
                                                              "error": null
                                                            }
                                                            """
                            ...
                            content = @Content(
                                    ...
                                    examples = {
                                            ...
                                            @ExampleObject(
                                                    name = "잘못된 요청 예시 2",
                                                    summary = "존재하지 않는 계좌",
                                                    value = "{\n  \"status\": \"ERROR\",\n  \"data\": null,\n  \"error\": {\n    \"statusCode\": 404,\n    \"message\": \"환불 계좌를 찾을 수 없습니다.\"\n  }\n}"
                                            ),
                                            @ExampleObject(
                                                    name = "잘못된 요청 예시 3",
                                                    summary = "존재하지 않는 은행",
                                                    value = "{\n  \"status\": \"ERROR\",\n  \"data\": null,\n  \"error\": {\n    \"statusCode\": 404,\n    \"message\": \"은행 정보를 찾을 수 없습니다.\"\n  }\n}"
                                            ),
                                            @ExampleObject(
                                                    name = "잘못된 요청 예시 4",
                                                    summary = "존재하지 않는 지갑 주소",
                                                    value = "{\n  \"status\": \"ERROR\",\n  \"data\": null,\n  \"error\": {\n    \"statusCode\": 404,\n    \"message\": \"메타마스크 지갑을 찾을 수 없습니다.\"\n  }\n}"
                                            )
                                    }
                            )
                    )
