...
import com.rabbit.blockchain.domain.entity.PromissoryNoteEntity;
...
public interface PromissoryNoteRepository extends JpaRepository<PromissoryNoteEntity, Long> {
     ...
     * @return 차용증 NFT 정보
     */
    Optional<PromissoryNoteEntity> findByTokenIdAndDeletedFlagFalse(Long tokenId);
    ...
    List<PromissoryNoteEntity> findByTokenIdsAndDeletedFlagFalse(@Param("tokenIds") List<Long> tokenIds);
}